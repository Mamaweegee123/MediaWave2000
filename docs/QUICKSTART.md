# MediaWave v0.1.0 Private Beta Quick Start

## Windows

1. Extract the entire Windows ZIP into a writable folder.
2. Keep `MediaWave.exe`, `_internal`, and `MediaWave Converter` together.
3. Launch `MediaWave.exe`.
4. Choose a folder containing your channel folders when prompted.

## macOS

1. Extract the macOS ZIP.
2. Move the included app bundles to Applications if desired.
3. Launch MediaWave and choose a folder containing your channel folders.
